        ...
        <div className="container">
          ...
          >
            <motion.div variants={fadeInUp}>
              <h2 className='2xl:text-[48px] lg:text-[36px] text-[26px] font-normal md:mb-[15px] mb-[8px]'>
                Convenient Payments With Alice 1
              </h2>
              <p className='lg:text-[24px] md:text-[18px] text-[14px] md:mb-[35px] mb-[30px]'>
                We created Alice 1 to make your POS and retail transactions seamless and quick wherever you go worldwide.
              </p>
              <ul className='flex flex-col md:gap-[30px] gap-[15px] lg:w-[85%] w-full'>
                <motion.li
                  className="flex lg:gap-[15px] gap-[10px] md:text-[20px] text-[14px] bg-white border border-[#A9ED12] md:rounded-[20px] rounded-[15px] py-[20px] px-[15px] mr-[50px]"
                  variants={fadeInUp}
                >
                ...
                <motion.li
                  className="flex lg:gap-[15px] gap-[10px] md:text-[20px] text-[14px] bg-white border border-[#A9ED12] md:rounded-[20px] rounded-[15px] py-[20px] px-[15px] ml-[50px]"
                  variants={fadeInUp}
                >
                  <span className='text-[#424242] text-[16px] mt-[5px]'><IoMdCheckmarkCircle /></span>
          ...
          {/* second column */}
          <motion.div
            className="grid md:grid-cols-2 gap-[40px] md:mt-[-100px] mt-[60px]"
            variants={stagger}
            initial="hidden"
            animate={controls}
          >
            ...
            <motion.div variants={fadeInUp}>
              <h2 className='2xl:text-[48px] lg:text-[36px] text-[26px] font-normal mb-[30px]'>
                Seamless Access Control With Alice 2
              </h2>
