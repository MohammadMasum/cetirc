        ...
        <section className=''>
            <div className="container">
                <div className="flex flex-col items-center text-center mb-[50px]">
                    <h2 className='section-title mb-[20px]'><span className='font-normal'>Why Use</span> <br /> Palm Vein Biometrics?</h2>
                ...
                <div className="grid grid-cols-3 gap-[30px]">
                    ...
                    <div className="bg-white py-[30px] px-[20px] rounded-[23px] text-center shadow-[0_30px_60px_rgba(0,0,0,0.05)]">
                        <Image className="mb-[10px] mx-auto" src={WhyUsIcon1} alt="Why Us Icon 1"/>
                        <h3 className='text-[30px] font-medium mb-[30px] leading-[1.3]'>High Security:</h3>
                    ...
                    {/* single box  */}
                    <div className="bg-white py-[30px] px-[20px] rounded-[23px] text-center shadow-[0_30px_60px_rgba(0,0,0,0.05)]">
                        <Image className="mb-[10px] mx-auto" src={WhyUsIcon2} alt="Why Us Icon 2"/>
                        <h3 className='text-[30px] font-medium mb-[30px] leading-[1.3]'>Contactless</h3>
                    ...
                    {/* single box  */}
                    <div className="bg-white py-[30px] px-[20px] rounded-[23px] text-center shadow-[0_30px_60px_rgba(0,0,0,0.05)]">
                        <Image className="mb-[10px] mx-auto" src={WhyUsIcon3} alt="Why Us Icon 3"/>
                        <h3 className='text-[30px] font-medium mb-[30px] leading-[1.3]'>Accurate and Reliable</h3>
