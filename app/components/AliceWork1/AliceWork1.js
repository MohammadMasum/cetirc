                    ...
                    <div className='relative'>
                        ...
                        <div className='flex gap-x-[18px] relative lg:pb-[50px] pb-[30px] before:w-[2px] before:absolute before:h-full before:content-[unset] before:lg:content-[""] before:border-l-2 before:border-dashed before:top-[40px] before:left-[14px]'>
                            ...
                            <div>
                                ...
                                <p className='text-[#646464] lg:text-[20px] text-[14px]'>After registration, you can make payments at partnering merchants, retail stores, or centers by simply scanning your palm at the point of sale terminal. The system compares your palm image with the palm signatures in our system to authenticate the transaction securely and swiftly.</p>
                            </div>
                        </div>
                        {/* single work item  */}
